...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionsForOnlyOptionalAttendees() {
    ...
    Collection<TimeRange> expected = Arrays.asList(TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0800AM, false),
        TimeRange.fromStartEnd(TIME_0830AM, TIME_0900AM, false), TimeRange.fromStartEnd(TIME_0930AM, TimeRange.END_OF_DAY, true));
  ...
  @Test
  public void noOptionsForOnlyOptionalAttendees() {
    Collection<Event> events = Arrays.asList(
  ...
  public void everyAttendeeIsConsidered() {
   ...
   @Test
  public void optionalAttendeeIsWholeDay() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void optionalAttendeeinMorning() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  public void justEnoughRoom() {
   ...
   @Test
  public void justOptionalEnoughRoom() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    //
    // Events  : |--A--|     |----A----|
